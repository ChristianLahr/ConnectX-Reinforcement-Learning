...
def player_1_agent(observation, configuration):
    action, prob_weights = get_action(player_1_model, observation, 0, config)
...
LEARNING_RATE = 0.1
EPISODES = 500
switch_to_negamax = 100000
player_1_model = create_model(type='dense')
...
checkpoint_path = "models/DQN/dqn_DENSE_extra_2.ckpt"
